...
describe('cloth skeleton', () => {
  ...
  test('cloth skeleton logout button', () => {
    render( <Provider store={store}>
      <App/>
    </Provider>
    );
